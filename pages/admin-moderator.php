          ...
          <div class="zerogrid">
            <div class="wrap-box">
              ...
              <div class="box-content">
                <form method="POST" action="../include/add-text.php">
                    <textarea cols="80" name="textarea" id="mess" cols="48" rows="10"></textarea>
                    <input type="text" value="" placeholder="title" name="title">
                    <input type="text" value=""  placeholder="image" name="image">
                    <input type="text" value="" placeholder="image2" name="image2">
                  <input type="submit" value="Постить" name="B1">
                </form>
              </div>
            </div>
          </div>
