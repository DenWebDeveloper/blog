			...
			<div class="wrap-container">
				<section class="content-box zerogrid">
					<div class="row wrap-box"><!--Start Box-->
						<h3 class="t-center" style="font-size: 30px;margin: 10px 0 30px">Авторизация</h3>
						<div id="contact_form">
							<!--Warning-->
							<form name="form1" id="ff" method="post" action="include/login.php">
								<label class="row">
									<div class="col-2-4">
										<div class="wrap-col">
									...
									<div class="col-2-4">
										<div class="wrap-col">
											<input type="passwordl" name="password"  placeholder="Enter password"  />
										</div>
									</div>
				...
				<section class="content-box zerogrid">
					<div class="row wrap-box"><!--Start Box-->
						<h3 class="t-center" style="font-size: 30px;margin: 10px 0 30px">Регистрация</h3>
						<div id="contact_form">
							<!--Warning-->
							<form name="form1" id="ff" method="post" action="contact.php">
								<label class="row">
									<div class="col-2-4">
										<div class="wrap-col">
											<input type="text" name="name" id="name" placeholder="Enter login" required="required" />
										</div>
									</div>
									<div class="col-2-4">
										<div class="wrap-col">
									...
									<div class="col-2-4">
										<div class="wrap-col">
											<input type="text" name="name" id="name" placeholder="Enter password" required="required" />
										</div>
									</div>
									<div class="col-2-4">
										<div class="wrap-col">
											<input type="text" name="name" id="name" placeholder="Enter re-password" required="required" />
										</div>
									</div>
